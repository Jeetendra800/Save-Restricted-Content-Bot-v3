...
# ─── BOT / DATABASE CONFIG ──────────────────────────────────────────────────────
API_ID       = os.getenv("API_ID", "20288395")
API_HASH     = os.getenv("API_HASH", "1245317c7706166809189b4a7918b79c")
BOT_TOKEN    = os.getenv("BOT_TOKEN", "")
MONGO_DB     = os.getenv("MONGO_DB", "mongodb+srv://Love:VElXsLXXzqtkUdeQ@cluster0.daz8gly.mongodb.net/?appName=Cluster0")
DB_NAME      = os.getenv("DB_NAME", "telegram downloader")

# ─── OWNER / CONTROL SETTINGS ───────────────────────────────────────────────────
OWNER_ID     = list(map(int, os.getenv("OWNER_ID", "8429266518").split()))  # space-separated list
...
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/@Love_9636")
